...
+ (NSString *)quickConvert:(NSString *)hzString byConvertMode:(NSInteger)mode {
    ...
    for (int i = 0; i < hzLength; i++) {
        ...
        switch (mode) {
            case POAPinyinConvertModeFull:
                [string appendFormat:@"%@", pycell.pinyin];
                break;
            case POAPinyinConvertModeFirstWord:
                if ([pycell.pinyin length ]> 0) {
                    [string appendFormat:@"%@", [pycell.pinyin substringToIndex:1]];
                }
                break;
            case POAPinyinConvertModeFullUpper:
                [string appendFormat:@"%@", [pycell.pinyin uppercaseString]];
                break;
            default:
                [string appendFormat:@"%@", pycell.pinyin];
        }
